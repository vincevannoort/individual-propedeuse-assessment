...
class DS1302 {
 public:
  ...
  DS1302(hwlib::pin_out & ce_pin, hwlib::pin_in_out & io_pin, hwlib::pin_out & sclk_pin);
...
protected:
  hwlib::pin_out & ce_pin_;
  hwlib::pin_in_out & io_pin_;
  hwlib::pin_out & sclk_pin_;
  // hwlib::spi_bus_bit_banged_sclk_mosi_miso spi_bus_;
